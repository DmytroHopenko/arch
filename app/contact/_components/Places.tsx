  ...
  return (
    <section className="wrapper relative py-[76px] md:py-[200px] flex flex-col">
      ...
      <div className="relative flex flex-col lg:flex-row">
        <h1 className="title w-[250px] mb:w-[270px] mb-10">Contact Details</h1>
        <div className="relative md:w-full lg:w-auto mb-10 lg:mb-0 lg:ml-20">
        ...
        <div className="relative md:w-full lg:w-auto lg:ml-16">
